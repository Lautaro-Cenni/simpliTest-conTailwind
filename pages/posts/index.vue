<template>
    ...
    <div v-else class="posts">
        ...
        <div class="container mx-auto">
            <div class=" my-12 grid justify-center justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 grid-flow-row ">
                <Posts  v-for="post of posts" 
                    :key="post.id"
                    :id="post.id"
            ...
            <div class="w-full sm:w-4/5 flex flex-row content-center text-left SFDisplay">
